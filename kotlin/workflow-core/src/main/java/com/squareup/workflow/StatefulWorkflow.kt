...
abstract class StatefulWorkflow<
  ...
  abstract inner class RenderContext {
     ...
     */
    abstract val actionSink: Sink<WorkflowAction<StateT, OutputT>>
     ...
     * type.
     */
    abstract fun <ChildPropsT, ChildOutputT : Any, ChildRenderingT> renderChild(
